...
# Cameras start/stop
@app.route('/control/cameras/<string:command>/<int:cameraId>', methods=['POST'])
...
# Support Vision Models start/stop
@app.route('/control/vision-model/<string:command>/<int:modelId>', methods=['POST'])
...
# Support Vision Models Configuration
